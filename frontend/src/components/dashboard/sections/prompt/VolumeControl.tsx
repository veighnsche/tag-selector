...
import { decreaseTagStrength, increaseTagStrength, toggleHideTag, toggleMuteTag } from '../../../../store/reducers/tags'
...
export const VolumeControl = ({ location, tag }: VolumeControlProps) => {
  ...
  return <ButtonGroup fullWidth color={buttonColorMap[location]}>
